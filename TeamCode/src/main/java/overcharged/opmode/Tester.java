...
Tester
    ...
    public void runOpMode() {
        ...
        servos.add(fClaw);
        OcServo depoL = robot.depo.arm;
        servos.add(depoL);
        OcServo depoR = robot.depo.wrist;
        servos.add(depoR);
        OcServo angular = robot.depo.angular;
        servos.add(angular);
        ...
        servoTestInfos = new ServoTestInfo[]{
                ...
                new ServoTestInfo(
                        ...
                        robot.depo.WRIST_OPP_VERT),
                new ServoTestInfo(
                        angular,
                        robot.depo.ANGULAR_STRAIGHT,
                        robot.depo.ANGULAR_LEFT,
                        robot.depo.ANGULAR_RIGHT),
        };
    ...
    private void depoCalibrate(List<OcServo> servoCalibrateList) {
        ...
        int rightPos = (int)(robot.depo.wrist.getPosition());
