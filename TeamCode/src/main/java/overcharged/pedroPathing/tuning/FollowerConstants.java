...
public class FollowerConstants {
    ...
    private static double xMovement = 68.43252398887162;//81.34056;
    private static double yMovement = 22.82434396560675;//65.43028;
    ...
    public static double mass = 19.30;
    ...
    public static double centripetalScaling = 0.00098;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double forwardZeroPowerAcceleration = -19.05276154365285;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    // this is for curves
    public static double lateralZeroPowerAcceleration = -96.276053464266;//-89.83478406945214;//-78.15554;
    ...
    // This can be custom set for each Path.
    public static double pathEndTimeoutConstraint = 500;//1.5;
