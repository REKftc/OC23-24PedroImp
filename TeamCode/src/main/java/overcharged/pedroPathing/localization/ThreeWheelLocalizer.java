...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.003052874026449;//0.00052189;//8192 * 1.37795 * 2 * Math.PI * 0.5008239963;
    public static double STRAFE_TICKS_TO_INCHES = 0.003052874026449;//-0.450847085;//0.208526196678693;//0.00052189;//8192 * 1.37795 * 2 * Math.PI * 0.5018874659;
    public static double TURN_TICKS_TO_RADIANS = 0.003049183519;//0.00053717;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    public static double LATERAL_DISTANCE = 13.504238;
    public static double FORWARD_OFFSET = -1.25;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        leftEncoderPose = new Pose(0, LATERAL_DISTANCE / 2, 0); // left
        rightEncoderPose = new Pose(0, -LATERAL_DISTANCE / 2, 0); // right
        strafeEncoderPose = new Pose(FORWARD_OFFSET, 0, Math.toRadians(90)); // front
        ...
        */
        ...
        leftEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "driveLF"));
