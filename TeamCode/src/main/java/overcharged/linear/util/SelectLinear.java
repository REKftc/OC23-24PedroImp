...
public class SelectLinear
{
    ...
    public boolean selectCycleNumber ()
            throws InterruptedException {
        RobotLog.i("entered alliance selection");

        String[] cycleNumber = new String[] {"More", "Less"};
        int index = select(cycleNumber,
                "Cycle Number");
        return index == 0;
    }

    public boolean selectExtraWait ()
            throws InterruptedException {
        RobotLog.i("entered alliance selection");

        String[] cycleNumber = new String[] {"No", "Yess"};
        int index = select(cycleNumber,
                "Extra Wait");
        return index == 0;
    }
